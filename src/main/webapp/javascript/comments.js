                ...
                <li class="comment-page">
                    <div class="padding">
                        <div class="comment-body">
                            <img src="images/${jsonList[j]["user"]["image"]}" class="avatar" alt="">
                            <div class="user-info">
                                <p class="meta">${jsonList[j]["commentDate"]}&#160&#160<a href="#">${jsonList[j]["user"]["username"]}</a> says : 
                                    <i class="pull-right">
                                        <a href="#">
                            ...
                            <div class="insights">
                                <a onclick="likeInsight(this)" href="javascript:void(0);" class="like">
                                    <i class="bi bi-hand-thumbs-up"></i><span class="likeInsight">${jsonList[j]["likeCount"]}</span>
                                </a>

                                <a href="comments?post-date=${jsonList[j]["post"]["postedDate"]}&title=${jsonList[j]["post"]["title"]}" class="dislike">
                                    <i class="bi bi-hand-thumbs-down"></i> <span class="dislikeInsight">${jsonList[j]["dislikeCount"]}</span>
                                </a>
                            </div>
